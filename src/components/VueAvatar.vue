...
<script>
    export default {
        props: {
            ...
            placeholder: {
                type: String,
                default: 'data:image/svg+xml,%3Csvg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 65 65"%3E%3Cdefs%3E%3Cstyle%3E.cls-1%7Bfill:%23000;%7D%3C/style%3E%3C/defs%3E%3Ctitle%3EUpload_Upload%3C/title%3E%3Cpath class="cls-1" d="M32.5,1A31.5,31.5,0,1,1,1,32.5,31.54,31.54,0,0,1,32.5,1m0-1A32.5,32.5,0,1,0,65,32.5,32.5,32.5,0,0,0,32.5,0h0Z"/%3E%3Cpolygon class="cls-1" points="41.91 28.2 32.59 18.65 23.09 28.39 24.17 29.44 31.87 21.54 31.87 40.05 33.37 40.05 33.37 21.59 40.83 29.25 41.91 28.2"/%3E%3Cpolygon class="cls-1" points="40.66 40.35 40.66 44.35 24.34 44.35 24.34 40.35 22.34 40.35 22.34 44.35 22.34 46.35 24.34 46.35 40.66 46.35 42.66 46.35 42.66 44.35 42.66 40.35 40.66 40.35"/%3E%3C/svg%3E'
            },
            borderRadius: {
                type: Number,
                default: 0
        ...
        mounted() {
            ...
            if (!this.image) {
                ...
                placeHolder.src = this.placeholder;

                placeHolder.onload = () => {
                    const x = this.canvasWidth / 2 - placeHolder.width / 2;
                    const y = this.canvasHeight / 2 - placeHolder.height / 2;
                    this.context.drawImage(placeHolder, x, y, placeHolder.width, placeHolder.height);
                };
            } else {
        ...
        methods: {
            ...
            getBoundedX(x, scale) {
                ...
                let width = Math.abs(image.width * Math.cos(this.rotationRadian)) +
            ...
            getBoundedY(y, scale) {
                var image = this.state.image;
                var dimensions = this.getDimensions();
                let height = Math.abs(image.width * Math.sin(this.rotationRadian)) +
            ...
            toDataUrl() {
                const canvas = this.getImageScaled();
